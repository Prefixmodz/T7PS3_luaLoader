...
static symbol<int(lua_state* s, const HksCompilerSettings* options, void* reader, void* readerData, void* debugReader, void* debugReaderData, const char* chunkName)>hksi_hks_load{ hksi_hks_load_a };
